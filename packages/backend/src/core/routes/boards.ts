...
export const bind_boards_routes = (fastify: FastifyInstance, db: Awaited<ReturnType<typeof create_db_connection>>) => {
  ...
  fastify.get('/api/v2/board/:board_tag', async (request: ReqBoard, reply) => {
  ...
  fastify.get('/api/v2/board/:board_tag/threads', async (request: ReqBoardThreads, reply) => {
  ...
  fastify.get('/api/v2/thread/:post_id', async (request: ReqThread, reply) => {
  ...
  fastify.get('/api/v2/post/:post_id', async (request: ReqPostById, reply) => {
